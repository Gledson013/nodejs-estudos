...
const validarNumeroInformado = (numero) => {    
        ...
        if(!resultado){
            console.log('numero informado nao e valido'); // Na aula é usado crase ``
        }
        return resultado
}
                    ...
                    if(operadorValidado){
                        switch(operadorValidado){
                            ...
                            case '-' : console.log(`operador selecionado subtracao resultado ${numeroValidado1} - ${numeroValidado2} = ${numeroValidado1 - numeroValidado2}`);    
                                break;
                            case '*' : console.log(`operador selecionado multiplicalcao resultado ${numeroValidado1} * ${numeroValidado2} = ${numeroValidado1 * numeroValidado2}`);
                                break;
